package c0_introduzione;

/**
 * ● È dato un array A[1..n-1] contenente una permutazione
 * degli interi da 1 a n (estremi inclusi) a cui è stato tolto un
 * elemento; i valori in A possono comparire in un ordine
 * qualsiasi
 * – Es: A = [1, 3, 4, 5] è una permutazione di 1..5 a cui è stato tolto il
 * numero 2
 * – Es: A = [7, 1, 3, 5, 4, 2] è una permutazione di 1..7 a cui è stato
 * tolto il numero 6
